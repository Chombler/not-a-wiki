	...
	<div class="shlisting">
		<div class="shelementwhole">
			...
			<div class="autohide">
				...
				<p><img src="/realm/Factions/picks/MagicianSlotUpgrade.png" alt="Warfare" align="middle"> <b>Magician</b> (R20+)</p>
				...
				<br/>
				<p><img src="/realm/Factions/picks/ArtisanSlotUpgrade.png" alt="Warfare" align="middle"> <b>Artisan</b> (R19+)</p>
				<p><b>Requirement</b>: Discover at least 10 Craftsmanship Researches.</p>
				<p><b>Cost</b>: 250 Noqag (2.5e152)</p>
				<p><b>Effect</b>: Increase Craftsmanship upgrade slot by 1</p>
				<br/>
				<p><img src="/realm/Factions/picks/DemigodSlotUpgrade.png" alt="Warfare" align="middle"> <b>Demigod</b> (R20+)</p>
				<p><b>Requirement</b>: Discover at least 10 Divine Researches.</p>
				<p><b>Cost</b>: 250 Noqag (2.5e152)</p>
				<p><b>Effect</b>: Increase Divine upgrade slot by 1</p>
				<br/>
				<p><img src="/realm/Factions/picks/BusinessmanSlotUpgrade.png" alt="Warfare" align="middle"> <b>Businessman</b> (R20+)</p>
				<p><b>Requirement</b>: Discover at least 10 Economics Researches</p>
				<p><b>Cost</b>: 250 Noqag (2.5e152)</p>
				<p><b>Effect</b>: Increase Economics upgrade slot by 1</p>
				<br/>
				<p><img src="/realm/Factions/picks/ApothecarySlotUpgrade.png" alt="Warfare" align="middle"> <b>Apothecary</b> (R17+)</p>
				<p><b>Requirement</b>: Discover at least 10 Alchemy Researches</p>
				<p><b>Cost</b>: 250 Noqag (2.5e152)</p>
				<p><b>Effect</b>: Increase Alchemy upgrade slot by 1</p>
				<br/>
				<p><img src="/realm/Factions/picks/WarlordSlotUpgrade.png" alt="Warfare" align="middle"> <b>Warlord</b> (R20+)</p>
				...
				<p><b>Note</b>: Upgrade only needs to be bought once.</p>
				<br>
				<p><img src="/realm/Factions/picks/Apeiron.png" align="middle"> <b>Artifact-Apeiron</b> (R175+)</p>
		...
		<div class="shelementwhole">
			...
			<div class="autohide">
				...
				<br/>
				<p><img src="/realm/Factions/picks/Spellcraft.png" alt="Spellcraft" align="middle"> <b>Spellcraft</b> (R16+)</p>
				...
				<p><b>Formula</b>: (100,000 * (1 + 0.01 * x ^ 0.7))%, where x is RP total of facility affinities.</p>
				<br/>
				<p><img src="/realm/Factions/picks/Divine.png" alt="Divine" align="middle"> <b>Divine</b> (R16+)</p>
				...
				<p><b>Formula</b>: (100,000 * (1 + 0.01 * x ^ 0.7))%, where x is RP total of facility affinities.</p>
				<br/>
				<p><img src="/realm/Factions/picks/Economics.png" alt="Economics" align="middle"> <b>Economics</b> (R16+)</p>
				...
				<p><b>Formula</b>: (100,000 * (1 + 0.01 * x ^ 0.7))%, where x is RP total of facility affinities.</p>
				<br/>
				<p><img src="/realm/Factions/picks/Alchemy.png" alt="Alchemy" align="middle"> <b>Alchemy</b> (R16+)</p>
				...
				<p><b>Formula</b>: (100,000 * (1 + 0.01 * x ^ 0.7))%, where x is RP total of facility affinities.</p>
				<br/>
				<p><img src="/realm/Factions/picks/Warfare.png" alt="Warfare" align="middle"> <b>Warfare</b> (R16+)</p>
				...
				<p><b>Formula</b>: (100,000 * (1 + 0.01 * x ^ 0.7))%, where x is RP total of facility affinities.</p>
				<br/>
				<p><img src="/realm/Factions/picks/Forbidden.png" align="middle"> <b>Forbidden</b> (R180+)</p>
	...
	<div class="shlisting">
		<div class="shelementwhole">
			...
			<div class="autohide">
				...
				<br/>
				<p><b><img src="/realm/Factions/picks/Fairyr2.png" alt="Enchanted Field" align="middle"> Enchanted Field</b></p>
				...
				<hr>
				<h6>Elf</h6>
				<p><img src="/realm/Factions/picks/Elfr1.png" alt="Training Grounds Quest" align="middle"> Elven Training Grounds Quest</p>
				...
				<p><b>Cost</b>: 10 Dtg (1E100)</p>
				<br/>
				<p><img src="/realm/Factions/picks/Elfr2.png" alt="Elven Training Grounds" align="middle"> Elven Training Grounds</p>
				...
				<p><b>Cost</b>: 10 Ttg (1E103)</p>
				<br/>
				<p><img src="/realm/Factions/picks/Carpentryr.png" alt="Elven Training Grounds" align="middle"> Carpentry</p>
				...
				<hr>
				<h6>Angel</h6>
				<p><img src="/realm/Factions/picks/Angelr1.png" alt="Heaven's Domain Quest" align="middle"> Heaven's Domain Quest</p>
				...
				<p><b>Cost</b>: 10 Ttg (1E103)</p>
				<br/>
				<p><img src="/realm/Factions/picks/Pantheonr.png" alt="Heaven's Domain Quest" align="middle"> Pantheon</p>
				...
				<hr>
				<h6>Goblin</h6>
				<p><b><img src="/realm/Factions/picks/Goblinr1.png" alt="Goblin Banks Quest" align="middle"> Goblin Banks Quest</b></p>
