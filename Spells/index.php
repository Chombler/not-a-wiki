...
<head>
	...
	<p>In later stages of the game you unlock more spells and spells can also have additional tiers. More information on Spell Tiers can be found <a target="_blank" href="/realm/SpellTiers/">here</a>.</p>
	<hr>
		...
		<table class="imgtable">
			<tr>
				<td>
					...
					<center><img src="/realm/Factions/picks/SpellsMap.png" usemap="#Spells-map"></center>
				</td>
			</tr>
		</table>
	</center>
					...
					<table class="imgtable">
						<tr>
							<td>
								...
								<center><img src="/realm/Factions/picks/SpellTrophyMap.png" usemap="#SpellTrophy-map"></center>
							</td>
							<td>
								<center>Challenge Reward Menu</center>
								<center><img src="/realm/Factions/picks/ChallengeRewardMap.png" usemap="#ChallengeReward-map"></center>
							</td>
						</tr>
					</table>
				</center>
	...
	<p><b>Formula</b>: (10 * ln(1 + x) ^ 4)%, where x is Mana Regeneration (mana/s).</p>
	...
	<p><b>Formula</b>: (1.3 * x ^ 0.7)%, where x is the amount of clicks made in this Reincarnation.</p>
	...
	<p><b><img src='/realm/Factions/picks/DiamondPickaxe.png' alt='Good' align='middle'> Diamond Pickaxe</b></p>
	...
	<p><b>Formula</b>: (30 * x)%, where x is your excavation depth.
		" coords="250,10,304,64" shape="rect">
		<area href="#ShareBenefits" research="
	<p><b><img src='/realm/Factions/picks/ShareBenefits.png' alt='Good' align='middle'> Share Benefits</b></p>
	...
	<p><b>Effect</b>: Increase assistant production by (50 + 50 * x)%, where x is the number of Necropolises you own.</p>
	...
	<p><b>Faction Coin Formula</b>: +(80 + 2.25 * ln(10 + x) ^ 2.25), where x is your current amount of Gems.</p>
	<p><b>Production Formula</b>: (30 + 3 * ln(1 + x) ^ 3)%, where x is the number of Faction Coins found in this Era.</p>
	...
	<p><b>Effect</b>: Increase production of all buildings by a cumulative 20% per second.</p>
	...
	<p><b>Formula</b>: (2500 * (1 + 0.005 * R) * (T + 1))%, where R is the number of times you have reincarnated and T is the spell tier.</p>
		" coords="190,130,244,184" shape="rect">
		<area href="#DragonsBreath" research="
	<p><b><img src='/realm/Factions/picks/DragonsBreath.png' alt='Neutral' align='middle'> Dragon's Breath</b></p>
	...
	<p><b>Formula (Faction Coins)</b>: (0.01 * ln(1 + x) ^ 4)%, where x is Faction Coins found this Era.</p>
	<p><b>Formula (Assistants)</b>: (0.1 * ln(1 + x) ^ 5)%, where x is the number of assistants.</p>
	...
	<p><b>Formula</b>: (0.5 * ln(1 + x) ^ 3 + x ^ 0.5)%, where x is Mana Regeneration (mana/s).</p>
	<p><b>Effect</b>: Also multiplicatively increase Faction Coin find chance based on your Mana Regeneration rate.</p>
	<p><b>Formula</b>: (4.5 * ln(1 + x) ^ 2.25 + 12.5 * x ^ 0.125)%, where x is Mana Regeneration (mana/s).</p>
	...
	<p><b>Note</b>: Formula improves to (1.3 * ln(1 + x) ^ 1.25)% with AR2.</p>
	...
	<p><b>Formula</b>: (1.5 * ln(1 + x) ^ 1.5)%, where x is Faction Coin find chance.</p>
	...
	<p><b>Formula</b>: (10 + 0.1 * x ^ 0.75)%, where x is your excavation depth.</p>
		" coords="130,250,184,304" shape="rect">
		<area href="#Catalyst" research="
	<p><b><img src='/realm/Factions/picks/Catalyst.png' alt='Order' align='middle'> Catalyst</b></p>
	<p><b>Spell Type</b>: (Chaos) Djinn Faction Spell (R130+)</p>
	<p><b>Cost</b>: 500,000 Mana - <b>Duration</b>: Fixed to 60 seconds</p>
	<p><b>Effect</b>: Activates two random unavailable vanilla or base-alignment spells at a tier equal to your Ascension for 60 seconds. This spell's duration cannot be modified.</p>
	...
	<p><b><img src='/realm/Factions/picks/ChaosMadness.png' alt='Order' align='middle'> Chaos Madness</b></p>
	...
	<p><b><img src='/realm/Factions/picks/TaxCollection.png' alt='Order' align='middle'> Tax Collection</b></p>
	<p><b>Spell Type</b>: Default Spell</p>
	<p><b>Cost</b>: 200 Mana (1,000 Mana in A4) - <b>Duration</b>: None</p>
	...
	<p><b>Effect</b>: Lineage levels count +2 more per tier.</p>
	...
	<p><b>Requirement</b>: Cast Moon Blessing with at least 5 Elven Luck triggers in this Era.</p>
	<p><b>Cost</b>: 1 M (1e6), A1+ Free</p>
	<p><b>Effect</b>: Autoclicks 15 times per second while Moon Blessing is active.</p>
		" coords="70,10,124,64" shape="rect">
		<area href="#GodsHand" research="
	<p><b><img src='/realm/Factions/picks/GodsRestSpellUpgrade.png' align='middle'> God's Rest</b></p>
	...
	<p><b>Requirement</b>: Find 30,000 Faction Coins using Diamond Pickaxe in a single Era.</p>
	...
	<p><b>Requirement</b>: Cast Goblin's Greed with at least 100 Royal Exchanges purchased.</p>
	<p><b>Cost</b>: 1 M (1e6), A1+ Free</p>
	...
	<p><b>Requirement</b>: Cast Night Time with at least 20,000% Offline production.</p>
	<p><b>Cost</b>: 1 M (1e6), A1+ Free</p>
	<p><b>Effect</b>: Increase Night Time's assistant-production bonus by (0.4 * x ^ 0.6)%, where x is its activity time in this Reincarnation; Offline time also counts 50% more.</p>
		" coords="70,70,124,124" shape="rect">
		<area href="#HellfireBlast" research="
	<p><b><img src='/realm/Factions/picks/HellRushSpellUpgrade.png' align='middle'> Hell Rush</b></p>
	...
	<p><b>Effect</b>: Hellfire Blast also boosts Halls of Legends.</p>
		" coords="130,70,184,124" shape="rect">
		<area href="#ComboStrike" research="
	<p><b><img src='/realm/Factions/picks/PerfectComboSpellUpgrade.png' align='middle'> Perfect Combo</b></p>
	<p><b>Requirement</b>: Cast a chain of 50 Combo Strikes in a single Era. The chain is interrupted by casting different spells.</p>
	<p><b>Cost</b>: 100 Sxd (1e53), A1+ Free</p>
	<p><b>Effect</b>: Increase the Combo Strike counter based on your longest Era in this Reincarnation.</p>
	<p><b>Formula</b>: +(2.5 * x ^ 0.5), where x is the longest Era time in this Reincarnation, in seconds.</p>
		" coords="190,70,244,124" shape="rect">
		<area href="#LightningStrike" research="
	...
	<p><b>Formula</b>: -(0.0005 * ln(1 + x)), where x is assistants owned.</p>
		" coords="130,190,184,244" shape="rect">
		<area href="#TaxCollection" research="
	<p><b><img src='/realm/Factions/picks/CoinPillageSpellUpgrade.png' align='middle'> Coin Pillage</b></p>
	...
	<map name="ChallengeReward-map">
		<area href="#FairyChanting" research="
	<p><b><img src='/realm/Factions/picks/FairyOrchestraChallengeReward.png' align='middle'> Fairy Orchestra</b></p>
	...
	<p><b>Effect</b>: While Moon Blessing is active, increase the Elven Luck-trigger statistic each second by floor(1 + t ^ 0.2), where t is elapsed spell time in seconds.</p>
		" coords="70,10,124,64" shape="rect">
		<area href="#GodsHand" research="
	...
	<p><b>Effect</b>: Increase Diamond Pickaxe duration by 8 seconds, and its bonus to Faction Coin find chance is passively applied as a multiplier to excavations Faction Coin rewards.</p>
		" coords="190,10,244,64" shape="rect">
		<area href="#GoblinsGreed" research="
	<p><b><img src='/realm/Factions/picks/AvariceDriveChallengeReward.png' align='middle'> Avarice Drive</b></p>
	...
	<p><b>Formula</b>: (0.25 * x ^ 0.75)%, where x is time spent in this Reincarnation, in seconds.</p>
		" coords="70,70,124,124" shape="rect">
		<area href="#HellfireBlast" research="
	<p><b><img src='/realm/Factions/picks/HellfireBurstChallengeReward.png' align='middle'> Hellfire Burst</b></p>
	...
	<p><b>Formula</b>: floor((x / 100,000) ^ (0.2 / (0.5 * A + 1))), where x is Mana produced in this Reincarnation and A is Ascension.</p>
	...
	<p><b>Effect</b>: Reincarnations count 5% more per active Dragon's Breath.</p>
		" coords="190,130,244,184" shape="rect">
		<area href="#Precognition" research="
	<p><b><img src='/realm/Factions/picks/OmniscienceChallengeReward.png' align='middle'> Omniscience</b></p>
	...
	<p id="TaxCollection"><b><img src="/realm/Factions/picks/TaxCollection.png" alt="All Factions" align="middle"> Tax Collection</b> (All Factions)</p>
	<p><b>Cost</b>: 200 Mana (1,000 Mana in A4) - <b>Duration</b>: None</p>
	<p><b>Effect</b>: Instantly gain 30 seconds worth of coin production from buildings and assistants.</p>
	<p><b><img src="/realm/Factions/picks/CoinPillageSpellUpgrade.png" align="middle"> Coin Pillage</b></p>
	<p><b>Requirement</b>: Cast 120 Tax Collections in less than 5 seconds.</p>
...
<p><b>Spell Tier Effect</b>: Buildings count 5% more per spell tier.</p>
	...
	<div class="shlisting">
		<div class="shelementwhole">
			<p onclick="shohid($(this));"><b><a href="#" onclick="return false;">Call to Arms Tier Upgrades</a></b> (R42+, limited by Ascension)</p>
			<div class="autohide">
				<p><b><img src="/realm/Factions/picks/CalltoArmsTier2.png" alt="Calltoarms2" align="middle"> Tier</b>: 2</p>
				<p><b>Cost</b> 51 Sxd (5.1e52) - <b>FC</b> 0</b></p>
				<p><b><img src="/realm/Factions/picks/CalltoArmsTier3.png" alt="Calltoarms3" align="middle"> Tier</b>: 3</p>
				<p><b>Cost</b> 51 Sxd (5.1e52) - <b>FC</b> 0</p>
				<p><b><img src="/realm/Factions/picks/CalltoArmsTier4.png" alt="Calltoarms4" align="middle"> Tier</b>: 4</p>
				<p><b>Cost</b> 51 Sxd (5.1e52) - <b>FC</b> 0</p>
				<p><b><img src="/realm/Factions/picks/CalltoArmsTier5.png" alt="Calltoarms5" align="middle"> Tier</b>: 5</p>
				<p><b>Cost</b> 51 Sxd (5.1e52) - <b>FC</b> 0</p>
			</div>
		</div>
	</div>
...
<div class="shlisting">
	<div class="shelementwhole">
		<p onclick="shohid($(this));"><b><a href="#" onclick="return false;">Spiritual Surge Tier Upgrades</a></b> (R42+, limited by Ascension)</p>
		<div class="autohide">
			<p><b>Faction Coins Needed</b> Fairy, Elven, Angel, Goblin, Undead, Demon, Dwarven, Drow</p>
			<p><b><img src="/realm/Factions/picks/SpiritualSurgeTier2.png" alt="Spiritual Surge" align="middle"> Tier</b>: 2</p>
			<p><b>Cost</b> 70 Tvg (7e71) - <b>FC</b> 10 T (1e13) each</p>
			<p><b><img src="/realm/Factions/picks/SpiritualSurgeTier3.png" alt="Spiritual Surge" align="middle"> Tier</b>: 3</p>
			<p><b>Cost</b> 70 Tvg (7e71) - <b>FC</b> 891.3 T (8.913e14) each</p>
			<p><b><img src="/realm/Factions/picks/SpiritualSurgeTier4.png" alt="Spiritual Surge" align="middle"> Tier</b>: 4</p>
			<p><b>Cost</b> 70 Tvg (7e71) - <b>FC</b> 79.43 Qa (7.943e16) each</p>
			<p><b><img src="/realm/Factions/picks/SpiritualSurgeTier5.png" alt="Spiritual Surge" align="middle"> Tier</b>: 5</p>
			<p><b>Cost</b> 70 Tvg (7e71) - <b>FC</b> 7.079 Qi (7.079e18) each</p>
		</div>
	</div>
</div>
<hr>
...
<div class="shlisting">
	<div class="shelementwhole">
		<p onclick="shohid($(this));"><b><a href="#" onclick="return false;">Holy Light Tier Upgrades</a></b> (R46+, limited by Ascension)</p>
		<div class="autohide">
			<p><b>Faction Coins Needed</b> Fairy, Elven, Angel, Dwarf</p>
			<p><b><img src="/realm/Factions/picks/HolyLightTier2.png" alt="HolyLightTier2" align="middle"> Tier</b>: 2</p>
			<p><b>Cost</b> 54 Spd (5.4e55) - <b>FC</b> 1 B (1e9)</p>
			<p><b><img src="/realm/Factions/picks/HolyLightTier3.png" alt="HolyLightTier3" align="middle"> Tier</b>: 3</p>
			<p><b>Cost</b> 54 Spd (5.4e55) - <b>FC</b> 22.39 B (2.239e10)</p>
			<p><b><img src="/realm/Factions/picks/HolyLightTier4.png" alt="HolyLightTier4" align="middle"> Tier</b>: 4</p>
			<p><b>Cost</b> 54 Spd (5.4e55) - <b>FC</b> 501.2 B (5.012e11)</p>
			<p><b><img src="/realm/Factions/picks/HolyLightTier5.png" alt="HolyLightTier5" align="middle"> Tier</b>: 5</p>
			<p><b>Cost</b> 54 Spd (5.4e55) - <b>FC</b> 11.22 T (1.122e13)</p>
		</div>
	</div>
</div>
<br>
...
<div class="shlisting">
	<div class="shelementwhole">
		<p onclick="shohid($(this));"><b><a href="#" onclick="return false;">Blood Frenzy Tier Upgrades</a></b> (R44+, limited by Ascension)</p>
		<div class="autohide">
			<p><b>Faction Coins Needed</b> Goblin, Undead, Demon, Drow</p>
			<p><b><img src="/realm/Factions/picks/BloodfrenzyTier2.png" alt="Bloodfrenzytier" align="middle"> Tier</b>: 2</p>
			<p><b>Cost</b> 54 Spd (5.4e55) - <b>FC</b> 1 B (1e9)</p>
			<p><b><img src="/realm/Factions/picks/BloodfrenzyTier3.png" alt="Bloodfrenzytier" align="middle"> Tier</b>: 3</p>
			<p><b>Cost</b> 54 Spd (5.4e55) - <b>FC</b> 22.39 B (2.239e10)</p>
			<p><b><img src="/realm/Factions/picks/BloodfrenzyTier4.png" alt="Bloodfrenzytier" align="middle"> Tier</b>: 4</p>
			<p><b>Cost</b> 54 Spd (5.4e55) - <b>FC</b> 501.2 B (5.012e11)</p>
			<p><b><img src="/realm/Factions/picks/BloodfrenzyTier5.png" alt="Bloodfrenzytier" align="middle"> Tier</b>: 5</p>
			<p><b>Cost</b> 54 Spd (5.4e55) - <b>FC</b> 11.22 T (1.122e13)</p>
		</div>
	</div>
</div>
...
<p><b>Tier Formula</b>: (2500 * (1 + 0.005 * R) * (T + 1))%, where R is Reincarnation and T is the spell tier.</p>
<div class="shlisting">
	<div class="shelementwhole">
		<p onclick="shohid($(this));"><b><a href="#" onclick="return false;">Gem Grinder Tier Upgrades</a></b> (R48+, limited by Ascension)</p>
		<div class="autohide">
			<p><b>Faction Coins Needed</b> Fairy, Elven, Angel, Goblin, Undead, Demon, Dwarven, Drow</p>
			<p><b><img src="/realm/Factions/picks/GemGrinderTier2.png" alt="Gem Grinder" align="middle"> Tier</b>: 2</p>
			<p><b>Cost</b> 57 Ocd (5.7e58) - <b>FC</b> 5 B (5e9)</p>
			<p><b><img src="/realm/Factions/picks/GemGrinderTier3.png" alt="Gem Grinder" align="middle"> Tier</b>: 3</p>
			<p><b>Cost</b> 57 Ocd (5.7e58) - <b>FC</b> 142.5 B (1.425e11)</p>
			<p><b><img src="/realm/Factions/picks/GemGrinderTier4.png" alt="Gem Grinder" align="middle"> Tier</b>: 4</p>
			<p><b>Cost</b> 57 Ocd (5.7e58) - <b>FC</b> 4.061 T (4.061e12)</p>
			<p><b><img src="/realm/Factions/picks/GemGrinderTier5.png" alt="Gem Grinder" align="middle"> Tier</b>: 5</p>
			<p><b>Cost</b> 57 Ocd (5.7e58) - <b>FC</b> 115.7 T (1.157e14)</p>
		</div>
	</div>
</div>
<hr>
...
<p><b>Effect</b>: Triples your assistants while Fairy Chanting is active.</p>
<p><b>Cost</b>: 1 M (1e6), A1+ Free</p>
<p><b>Challenge Upgrade</b>: <b><img src="/realm/Factions/picks/FairyOrchestraChallengeReward.png" align="middle"> Fairy Orchestra</b> (R18+)</p>
<p><b>Effect</b>: Each assistant generates 3 times as many faction coins while Fairy Chanting is active.</p>
<div class="shlisting">
	<div class="shelementwhole">
		<p onclick="shohid($(this));"><b><a href="#" onclick="return false;">Fairy Chanting Tier Upgrades</a></b> (R46+, limited by Ascension)</p>
		<div class="autohide">
			<p><b>Faction Coins Needed</b> Fairy</p>
			<p><b>Effect</b>: Increases the duration of the spell by 10 seconds per tier.</p>
			<p><b><img src="/realm/Factions/picks/FairyChantingTier2.png" alt="FairyChanting" align="middle"> Tier</b>: 2</p>
			<p><b>Cost</b> 57 Ocd (5.7e58) - <b>FC</b> 10 B (1e10)</p>
			<p><b><img src="/realm/Factions/picks/FairyChantingTier3.png" alt="FairyChanting" align="middle"> Tier</b>: 3</p>
			<p><b>Cost</b> 57 Ocd (5.7e58) - <b>FC</b> 316.2 B (3.162e11)</p>
			<p><b><img src="/realm/Factions/picks/FairyChantingTier4.png" alt="FairyChanting" align="middle"> Tier</b>: 4</p>
			<p><b>Cost</b> 57 Ocd (5.7e58) - <b>FC</b> 10 T (1e13)</p>
			<p><b><img src="/realm/Factions/picks/FairyChantingTier5.png" alt="FairyChanting" align="middle"> Tier</b>: 5</p>
			<p><b>Cost</b> 57 Ocd (5.7e58) - <b>FC</b> 316.2 T (3.162e14)</p>
		</div>
	</div>
</div>
<br>
<p id="MoonBlessing"><b><img src="/realm/Factions/picks/MoonBlessing.png" alt="Good" align="middle"> Moon Blessing</b> (Elven)</p>
<p><b>Cost</b>: 700 Mana - <b>Duration</b>: 20 seconds </p>
...
<p><b>Formula</b>: (1.3 * x ^ 0.7)%, where x is the amount of clicks made in this Reincarnation.</p>
<p><b>Spell Trophy & Upgrade</b>: <b><img src="/realm/Factions/picks/SunBlessingSpellUpgrade.png" align="middle"> Sun Blessing</b></p>
<p><b>Requirement</b>: Cast Moon Blessing with at least 5 Elven Luck triggers in this Era.</p>
<p><b>Effect</b>: Autoclicks 15 times per second while Moon Blessing is active.</p>
<p><b>Cost</b>: 1 M (1e6), A1+ Free</p>
<p><b>Challenge Upgrade</b>: <b><img src="/realm/Factions/picks/StarBlessingChallengeReward.png" align="middle"> Star Blessing</b> (R18+)</p>
<p><b>Effect</b>: While Moon Blessing is active, increase the Elven Luck-trigger statistic each second by floor(1 + t ^ 0.2), where t is elapsed spell time in seconds.</p>
<div class="shlisting">
	<div class="shelementwhole">
		<p onclick="shohid($(this));"><b><a href="#" onclick="return false;">Moon Blessing Tier Upgrades</a></b> (R46+, limited by Ascension)</p>
		<div class="autohide">
			<p><b>Faction Coins Needed</b> Elven</p>
			<p><b>Effect</b>: While Sun Blessing is active, autoclick 2 additional times per tier.</p>
			<p><b><img src="/realm/Factions/picks/MoonBlessingTier2.png" alt="MoonBlessing" align="middle"> Tier</b>: 2</p>
			<p><b>Cost</b> 57 Ocd (5.7e58) - <b>FC</b> 10 B (1e10)</p>
			<p><b><img src="/realm/Factions/picks/MoonBlessingTier3.png" alt="MoonBlessing" align="middle"> Tier</b>: 3</p>
			<p><b>Cost</b> 57 Ocd (5.7e58) - <b>FC</b> 316.2 B (3.162e11)</p>
			<p><b><img src="/realm/Factions/picks/MoonBlessingTier4.png" alt="MoonBlessing" align="middle"> Tier</b>: 4</p>
			<p><b>Cost</b> 57 Ocd (5.7e58) - <b>FC</b> 10 T (1e13)</p>
			<p><b><img src="/realm/Factions/picks/MoonBlessingTier5.png" alt="MoonBlessing" align="middle"> Tier</b>: 5</p>
			<p><b>Cost</b> 57 Ocd (5.7e58) - <b>FC</b> 316.2 T (3.162e14)</p>
		</div>
	</div>
</div>
...
<div class="shlisting">
	<div class="shelementwhole">
		...
		<div class="autohide">
			...
			<p><b><img src="/realm/Factions/picks/God'sHandTier2.png" alt="God's Hand" align="middle"> Tier</b>: 2</p>
			<p><b>Cost</b> 57 Ocd (5.7e58) - <b>FC</b> 10 B (1e10)</p>
			<p><b><img src="/realm/Factions/picks/God'sHandTier3.png" alt="God's Hand" align="middle"> Tier</b>: 3</p>
			<p><b>Cost</b> 57 Ocd (5.7e58) - <b>FC</b> 316.2 B (3.162e11)</p>
			<p><b><img src="/realm/Factions/picks/God'sHandTier4.png" alt="God's Hand" align="middle"> Tier</b>: 4</p>
			<p><b>Cost</b> 57 Ocd (5.7e58) - <b>FC</b> 10 T (1e13)</p>
			<p><b><img src="/realm/Factions/picks/God'sHandTier5.png" alt="God's Hand" align="middle"> Tier</b>: 5</p>
			<p><b>Cost</b> 57 Ocd (5.7e58) - <b>FC</b> 316.2 T (3.162e14)</p>
		</div>
	</div>
</div>
<br>
<p id="DiamondPickaxe"><b><img src="/realm/Factions/picks/DiamondPickaxe.png" alt="Good" align="middle"> Diamond Pickaxe</b> (Dwarven)</p>
<p><b>Cost</b>: 1000 Mana - <b>Duration</b>: 12 seconds </p>
<p><b>Effect</b>: Increase clicking reward by (30 * x)%, where x is your excavation depth, and increase Faction Coin find chance by 200%.</p>
<p><b>Spell Trophy & Upgrade</b>: <b><img src="/realm/Factions/picks/MinedwarfSpellUpgrade.png" align="middle"> Minedwarf</b></p>
<p><b>Requirement</b>: Find 30,000 Faction Coins using Diamond Pickaxe in a single Era.</p>
<p><b>Effect</b>: Increases Diamond Pickaxe bonus to "Faction Coin Find Chance" to +300%.</p>
<p><b>Cost</b>: 100 Sxd (1e53), A1+ Free</p>
<p><b>Challenge Upgrade</b>: <b><img src="/realm/Factions/picks/IronGripChallengeReward.png" align="middle"> Iron Grip</b> (R33+)</p>
<p><b>Effect</b>: Increase Diamond Pickaxe duration by 8 seconds, and its bonus to Faction Coin find chance is passively applied as a multiplier to excavations Faction Coin rewards.</p>
<div class="shlisting">
	<div class="shelementwhole">
		<p onclick="shohid($(this));"><b><a href="#" onclick="return false;">Diamond Pickaxe Tier Upgrades</a></b> (R46+, limited by Ascension)</p>
		<div class="autohide">
			<p><b>Faction Coins Needed</b> Dwarf</p>
			<p><b>Effect</b>: Increases FC find chance per tier.</p>
			<p><b><img src="/realm/Factions/picks/DiamondPickaxeTier2.png" alt="Diamond Pickaxe" align="middle"> Tier</b>: 2</p>
			<p><b>Cost</b> 69 Dvg (6.9e70) - <b>FC</b> 1 T (1e12)</p>
			<p><b><img src="/realm/Factions/picks/DiamondPickaxeTier3.png" alt="Diamond Pickaxe" align="middle"> Tier</b>: 3</p>
			<p><b>Cost</b> 69 Dvg (6.9e70) - <b>FC</b> 63.1 T (6.31e13)</p>
			<p><b><img src="/realm/Factions/picks/DiamondPickaxeTier4.png" alt="Diamond Pickaxe" align="middle"> Tier</b>: 4</p>
			<p><b>Cost</b> 69 Dvg (6.9e70) - <b>FC</b> 3.981 Qa (3.981e15)</p>
			<p><b><img src="/realm/Factions/picks/DiamondPickaxeTier5.png" alt="Diamond Pickaxe" align="middle"> Tier</b>: 5</p>
			<p><b>Cost</b> 69 Dvg (6.9e70) - <b>FC</b> 251.2 Qa (2.512e17)</p>
		</div>
	</div>
</div>
<br>
...
<p><b>Effect</b>: While Goblin's Greed is active, Tax Collection costs 10% less Mana.</p>
<p><b>Cost</b>: 1 M (1e6), A1+ Free</p>
<p><b>Challenge Upgrade</b>: <b><img src="/realm/Factions/picks/AvariceDriveChallengeReward.png" align="middle"> Avarice Drive</b> (R18+)</p>
<p><b>Effect</b>: Goblin's Greed counts Faction Coins found in this Reincarnation.</p>
<div class="shlisting">
	<div class="shelementwhole">
		<p onclick="shohid($(this));"><b><a href="#" onclick="return false;">Goblin's Greed Tier Upgrades</a></b> (R44+, limited by Ascension)</p>
		<div class="autohide">
			<p><b>Faction Coins Needed</b> Goblin</p>
			<p><b><img src="/realm/Factions/picks/Goblin'sGreedTier2.png" alt="Goblin's Greed" align="middle"> Tier</b>: 2</p>
			<p><b>Cost</b> 57 Ocd (5.7e58) - <b>FC</b> 10 B (1e10)</p>
			<p><b><img src="/realm/Factions/picks/Goblin'sGreedTier3.png" alt="Goblin's Greed" align="middle"> Tier</b>: 3</p>
			<p><b>Cost</b> 57 Ocd (5.7e58) - <b>FC</b> 316.2 B (3.162e11)</p>
			<p><b><img src="/realm/Factions/picks/Goblin'sGreedTier4.png" alt="Goblin's Greed" align="middle"> Tier</b>: 4</p>
			<p><b>Cost</b> 57 Ocd (5.7e58) - <b>FC</b> 10 T (1e13)</p>
			<p><b><img src="/realm/Factions/picks/Goblin'sGreedTier5.png" alt="Goblin's Greed" align="middle"> Tier</b>: 5</p>
			<p><b>Cost</b> 57 Ocd (5.7e58) - <b>FC</b> 316.2 T (3.162e14)</p>
		</div>
	</div>
</div>
...
<p><b>Effect</b>: Increase Night Time's assistant-production bonus by (0.4 * x ^ 0.6)%, where x is its activity time in this Reincarnation; Offline time also counts 50% more.</p>
<p><b>Cost</b>: 1 M (1e6), A1+ Free</p>
<p><b>Challenge Upgrade</b>: <b><img src="/realm/Factions/picks/MidnightTimeChallengeReward.png" align="middle"> Midnight Time</b> (R18+)</p>
<p><b>Effect</b>: Increase Night Time assistant bonus based on time spent in this Reincarnation.</p>
<p><b>Formula</b>: (0.25 * x ^ 0.75)%, where x is time spent in this Reincarnation, in seconds.</p>
<div class="shlisting">
	<div class="shelementwhole">
		<p onclick="shohid($(this));"><b><a href="#" onclick="return false;">Night Time Tier Upgrades</a></b> (R44+, limited by Ascension)</p>
		<div class="autohide">
			<p><b>Faction Coins Needed</b> Undead</p>
			<p><b><img src="/realm/Factions/picks/NightTimeTier2.png" alt="Night Time" align="middle"> Tier</b>: 2</p>
			<p><b>Cost</b> 57 Ocd (5.7e58) - <b>FC</b> 10 B (1e10)</p>
			<p><b><img src="/realm/Factions/picks/NightTimeTier3.png" alt="Night Time" align="middle"> Tier</b>: 3</p>
			<p><b>Cost</b> 57 Ocd (5.7e58) - <b>FC</b> 316.2 B (3.162e11)</p>
			<p><b><img src="/realm/Factions/picks/NightTimeTier4.png" alt="Night Time" align="middle"> Tier</b>: 4</p>
			<p><b>Cost</b> 57 Ocd (5.7e58) - <b>FC</b> 10 T (1e13)</p>
			<p><b><img src="/realm/Factions/picks/NightTimeTier5.png" alt="Night Time" align="middle"> Tier</b>: 5</p>
			<p><b>Cost</b> 57 Ocd (5.7e58) - <b>FC</b> 316.2 T (3.162e14)</p>
		</div>
	</div>
</div>
...
<p><b>Effect</b>: Hellfire Blast also boosts Halls of Legends.</p>
<p><b>Cost</b>: 1 M (1e6), A1+ Free</p>
<p><b>Challenge Upgrade</b>: <b><img src="/realm/Factions/picks/HellfireBurstChallengeReward.png" align="middle"> Hellfire Burst</b> (R18+)</p>
<p><b>Effect</b>: Hellfire Blast also counts Evil spells cast in this reincarnation to increase its bonus.</p>
<div class="shlisting">
	<div class="shelementwhole">
		<p onclick="shohid($(this));"><b><a href="#" onclick="return false;">Hellfire Blast Tier Upgrades</a></b> (R44+, limited by Ascension)</p>
		<div class="autohide">
			...
			<p><b><img src="/realm/Factions/picks/HellfireBlastTier2.png" alt="Hellfire Blast" align="middle"> Tier</b>: 2</p>
			<p><b>Cost</b> 57 Ocd (5.7e58) - <b>FC</b> 10 B (1e10)</p>
			<p><b><img src="/realm/Factions/picks/HellfireBlastTier3.png" alt="Hellfire Blast" align="middle"> Tier</b>: 3</p>
			<p><b>Cost</b> 57 Ocd (5.7e58) - <b>FC</b> 316.2 B (3.162e11)</p>
			<p><b><img src="/realm/Factions/picks/HellfireBlastTier4.png" alt="Hellfire Blast" align="middle"> Tier</b>: 4</p>
			<p><b>Cost</b> 57 Ocd (5.7e58) - <b>FC</b> 10 T (1e13)</p>
			<p><b><img src="/realm/Factions/picks/HellfireBlastTier5.png" alt="Hellfire Blast" align="middle"> Tier</b>: 5</p>
			<p><b>Cost</b> 57 Ocd (5.7e58) - <b>FC</b> 316.2 T (3.162e14)</p>
		</div>
	</div>
</div>
...
<div class="shlisting">
	<div class="shelementwhole">
		...
		<div class="autohide">
			...
			<p><b><img src="/realm/Factions/picks/ComboStrikeTier2.png" alt="Combo Strike" align="middle"> Tier</b>: 2</p>
			<p><b>Cost</b> 69 Dvg (6.9e70) - <b>FC</b> 1 T (1e12)</p>
			<p><b><img src="/realm/Factions/picks/ComboStrikeTier3.png" alt="Combo Strike" align="middle"> Tier</b>: 3</p>
			<p><b>Cost</b> 69 Dvg (6.9e70) - <b>FC</b> 63.1 T (6.31e13)</p>
			<p><b><img src="/realm/Factions/picks/ComboStrikeTier4.png" alt="Combo Strike" align="middle"> Tier</b>: 4</p>
			<p><b>Cost</b> 69 Dvg (6.9e70) - <b>FC</b> 3.981 Qa (3.981e15)</p>
			<p><b><img src="/realm/Factions/picks/ComboStrikeTier5.png" alt="Combo Strike" align="middle"> Tier</b>: 5</p>
			<p><b>Cost</b> 69 Dvg (6.9e70) - <b>FC</b> 251.2 Qa (2.512e17)</p>
		</div>
	</div>
</div>
...
<div class="shlisting">
	<div class="shelementwhole">
		<p onclick="shohid($(this));"><b><a href="#" onclick="return false;">Lightning Strike Tier Upgrades</a></b> (R48+, limited by Ascension)</p>
		<div class="autohide">
			<p><b>Faction Coins Needed</b> Angel, Goblin</p>
			<p><b>Effect</b>: Iron Strongholds count for 75% more per tier for the spell bonus.</p>
			<p><b><img src="/realm/Factions/picks/LightningStrikeTier2.png" alt="Lightning Strike" align="middle"> Tier</b>: 2</p>
			<p><b>Cost</b> 60 Nod (6e61) - <b>FC</b> 50 B (5e10)</p>
			<p><b><img src="/realm/Factions/picks/LightningStrikeTier3.png" alt="Lightning Strike" align="middle"> Tier</b>: 3</p>
			<p><b>Cost</b> 60 Nod (6e61) - <b>FC</b> 2.013 T (2.013e12)</p>
			<p><b><img src="/realm/Factions/picks/LightningStrikeTier4.png" alt="Lightning Strike" align="middle"> Tier</b>: 4</p>
			<p><b>Cost</b> 60 Nod (6e61) - <b>FC</b> 81.03 T (8.103e13)</p>
			<p><b><img src="/realm/Factions/picks/LightningStrikeTier5.png" alt="Lightning Strike" align="middle"> Tier</b>: 5</p>
			<p><b>Cost</b> 60 Nod (6e61) - <b>FC</b> 3.262 Qa (3.262e15)</p>
		</div>
	</div>
</div>
<br>
<p id="Brainwave"><b><img src="/realm/Factions/picks/Brainwave.png" alt="Neutral" align="middle"> Brainwave</b> (Faceless)</p>
<p><b>Cost</b>: 600 Mana - <b>Duration</b>: 600 seconds </p>
<p><b>Effect</b>: Increase production of all buildings by a cumulative 20% per second.</p>
...
<div class="shlisting">
	<div class="shelementwhole">
		<p onclick="shohid($(this));"><b><a href="#" onclick="return false;">Brainwave Tier Upgrades</a></b> (R48+, limited by Ascension)</p>
		<div class="autohide">
			<p><b>Faction Coins Needed</b> Fairy, Undead</p>
			<p><b>Effect</b>: Brainwave headstarts for an additional 10 minutes per tier.</p>
			<p><b><img src="/realm/Factions/picks/BrainwaveTier2.png" alt="Brainwave" align="middle"> Tier</b>: 2</p>
			<p><b>Cost</b> 60 Nod (6e61) - <b>FC</b> 50 B (5E10)</p>
			<p><b><img src="/realm/Factions/picks/BrainwaveTier3.png" alt="Brainwave" align="middle"> Tier</b>: 3</p>
			<p><b>Cost</b> 60 Nod (6e61) - <b>FC</b> 2.013 T (2.013e12)</p>
			<p><b><img src="/realm/Factions/picks/BrainwaveTier4.png" alt="Brainwave" align="middle"> Tier</b>: 4</p>
			<p><b>Cost</b> 60 Nod (6e61) - <b>FC</b> 81.03 T (8.103e13)</p>
			<p><b><img src="/realm/Factions/picks/BrainwaveTier5.png" alt="Brainwave" align="middle"> Tier</b>: 5</p>
			<p><b>Cost</b> 60 Nod (6e61) - <b>FC</b> 3.262 Qa (3.262e15)</p>
		</div>
	</div>
</div>
...
<p><b>Effect</b>: Increases Grand Balance duration to 24 seconds and lower its cost by 200 mana.</p>
<p><b>Cost</b>: 10 Dd (1e40), A1+ Free</p>
<p><b>Challenge Upgrade</b>: <b><img src="/realm/Factions/picks/PrimalBalanceChallengeReward.png" align="middle"> Primal Balance</b></p>
<p><b>Effect</b>: Grand Balance now affects extra buildings based on Mana produced in this Reincarnation.</p>
<p><b>Formula</b>: floor((x / 100,000) ^ (0.2 / (0.5 * A + 1))), where x is Mana produced in this Reincarnation and A is Ascension.</p>
<p><b>Effect</b>: When the amount of additional targets exceeds 11, increase the production of all affected buildings based on the exceeding amount. Does not suffer from Ascension penalties.</p>
<p><b>Formula</b>: (3 * (x - 10) ^ 1.5)%, where x is the amount of additional targets.</p>
<p><b>Note</b>: A table for the amount of Mana needed can be found <a target="_blank" href="/realm/Druid/#DruidDCR">here</a>.</p>
<a id="Primal Balance"></a>
<div class="shlisting">
	<div class="shelementwhole">
		<p onclick="shohid($(this));"><b><a href="#" onclick="return false;">Grand Balance Tier Upgrades</a></b> (R48+, limited by Ascension)</p>
		<div class="autohide">
			<p><b>Faction Coins Needed</b> Elven, Demon</p>
			<p><b><img src="/realm/Factions/picks/GrandBalanceTier2.png" alt="Grand Balance" align="middle"> Tier</b>: 2</p>
			<p><b>Cost</b> 60 Nod (6e61) - <b>FC</b> 50 B (5E10)</p>
			<p><b><img src="/realm/Factions/picks/GrandBalanceTier3.png" alt="Grand Balance" align="middle"> Tier</b>: 3</p>
			<p><b>Cost</b> 60 Nod (6e61) - <b>FC</b> 2.013 T (2.013e12)</p>
			<p><b><img src="/realm/Factions/picks/GrandBalanceTier4.png" alt="Grand Balance" align="middle"> Tier</b>: 4</p>
			<p><b>Cost</b> 60 Nod (6e61) - <b>FC</b> 81.03 T (8.103e13)</p>
			<p><b><img src="/realm/Factions/picks/GrandBalanceTier5.png" alt="Grand Balance" align="middle"> Tier</b>: 5</p>
			<p><b>Cost</b> 60 Nod (6e61) - <b>FC</b> 3.262 Qa (3.262e15)</p>
		</div>
	</div>
</div>
...
<div class="shlisting">
	<div class="shelementwhole">
		<p onclick="shohid($(this));"><b><a href="#" onclick="return false;">Dragon's Breath Tier Upgrades</a></b> (Tier 2 at R54, Tier 3 at R60, Tier 4 at R66, Tier 5 at R72)</p>
		<div class="autohide">
			...
			<p><b><img src="/realm/Factions/picks/DragonsBreathTier2.png" alt="DragonsBreathTier2" align="middle"> Tier</b>: 2</p>
			<p><b>Cost</b> 69 Dvg (6.9e70) - <b>FC</b> 1 Qa (1e15) Dwarven, Drow</p>
			<p><b><img src="/realm/Factions/picks/DragonsBreathTier3.png" alt="DragonsBreathTier3" align="middle"> Tier</b>: 3</p>
			<p><b>Cost</b> 69 Dvg (6.9e70) - <b>FC</b> 177.8 Qa (1.778e17) Dwarven, Drow</p>
			<p><b><img src="/realm/Factions/picks/DragonsBreathTier4.png" alt="DragonsBreathTier4" align="middle"> Tier</b>: 4</p>
			<p><b>Cost</b> 69 Dvg (6.9e70) - <b>FC</b> 31.62 Qi (3.162e19) Dwarven, Drow</p>
			<p><b><img src="/realm/Factions/picks/DragonsBreathTier5.png" alt="DragonsBreathTier5" align="middle"> Tier</b>: 5</p>
			<p><b>Cost</b> 69 Dvg (6.9e70) - <b>FC</b> 5.623 Sx (5.623e21) Dwarven, Drow</p>
...
<p id="ShareBenefits"><b><img src="/realm/Factions/picks/ShareBenefits.png" alt="Round Table" align="middle"> Share Benefits</b> (Good Mercenary)</p>
<p><b>Cost</b>: 200 Mana - <b>Duration</b>: Fixed to 20 seconds</p>
...
<br/>
<p id="ReapInterests"><b><img src="/realm/Factions/picks/ReapInterests.png" alt="Tyrant Garrison" align="middle"> Reap Interests </b> (Evil Mercenary)</p>
<p><b>Cost</b>: 200 Mana (1,000 Mana in A4) - <b>Duration</b>: None</p>
...
<p><b>Effect</b>: Multiplicatively increase Maximum Mana based on Faction Coin find chance.</p>
<p><b>Formula</b>: (1.5 * ln(1 + x) ^ 1.5)%, where x is your Faction Coin find chance.</p>
<p><b>Effect</b>: Multiplicatively increase Faction Coin find chance based on Excavations made, including resets, in this Reincarnation.</p>
<p><b>Formula</b>: (10 + 0.1 * x ^ 0.75)%, where x is your excavation depth.</p>
<br/>
...
<p><b>Formula</b>: -(0.0005 * ln(1 + x)), where x is assistants owned.</p>
<p><b>Cost</b>: 10 Octg (1e118), A3+ Free</p>
<p><b>Challenge Upgrade</b>: <b><img src="/realm/Factions/picks/GaiasCradleChallengeReward.png" align="middle"> Gaia's Cradle</b> (R153+)</p>
<p><b>Effect</b>: All Infinite Spiral effects scale 15% faster.</p>
<hr>
<p id="Catalyst"><b><img src="/realm/Factions/picks/Catalyst.png" alt="Catalyst" align="middle"> Catalyst</b></p>
<p><b>Spell Type</b>: (Chaos) Djinn Faction Spell (R130+)</p>
<p><b>Cost</b>: 500,000 Mana - <b>Duration</b>: Fixed to 60 seconds</p>
...
<hr>
<p id="ChaosMadness"><b><img src="/realm/Factions/picks/ChaosMadness.png" alt="Chaos Madness" align="middle"> Chaos Madness</b> (Chaos Mercenary)</p>
<p><b>Spell Type</b>: (Chaos) Mercenary Faction Spell (R194+)</p>
<p><b>Cost</b>: 500,000 Mana - <b>Duration</b>: Fixed to 20 seconds</p>
