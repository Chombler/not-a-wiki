...
<?php include "../scripts/header.html"; ?>
	...
	<map name="ArtifactSets-map">
		...
		<p><b>Formula</b>: (log10(1 + x) ^ 2)%, where x is Faction Coins found this Era.</p>
		...
		<p><b>Additive Formula</b>: +(0.3 * x ^ 0.7)%, where x is time spent in this Era.</p>
		<p><b>Multiplicative Formula</b>: (0.45 * x ^ 0.45)%, where x is time spent in this Era.</p>
		...
		<p><b>Formula</b>: (0.5 * log10(1 + x) ^ 1.5)%, where x is spell casts this Era.</p>
		...
		<p><b>Effect</b>: Increases spell duration based on time spent being offline in this Era.</p>
		<p><b>Formula</b>: (0.5 * x ^ 0.5)%, where x is offline time this Era.</p>
		...
		<p><b>Penalties Reduction</b>: (round((0.3 * x / 3600) ^ 0.5) - 1), where x is time spent in this Era.</p>
		...
		<p><b>Formula</b>: (0.25 * (x * (y + 1)) ^ 0.5)%, where x is the number of excavations made, and y is your number of resets in this Era.</p>
	...
	<p><b>Second Effect Requirement</b>: R220+, Blood Chalice</p>
	<p><b>Effect</b>: Multiplicatively increases production bonus from gems based on Faction Coins found this Era.</p>
	<p><b>Formula</b>: (log10(1 + x) ^ 2)%, where x is faction coins this Era.</p>
	<br/>
	<H6 id="Demon"></h6>
	<p><b><img src="/realm/Factions/picks/DemonSet.png" align="middle"> Demon Set</b></p>
	<p><b>Requirement</b>: R100+, Demonic Figurine, Demon Horn, Crystallized Lava</p>
	...
	<p><b>Effect</b>: Remove Ascension penalties from Royal Exchange bonus, starting from 0 and removing more levels of penalty over time and increase their production based on the amount of Gems you own.</p>
	<p><b>Formula</b>: (log10(1 + x) ^ 2)%, where x is the amount of Gems you own.</p>
	<p><b>Penalty Reduction</b>: (round((0.3 * x / 3600) ^ 0.5) - 1), where x is time spent in this Era.</p>
