...
<?php include "../scripts/header.html"; ?>
	<h6><a href="/realm/Factions/"><img src="/realm/Factions/picks/DwarfTopPage.png" alt="Spellcraft" align="middle"></a></h6>
	...
	<p>The Dwarven Faction appears in addition to a good faction and enables the player to use all the 2 faction spells and 18 upgrades from both the Good and Dwarven factions.</p>
	<p>The Dwarven faction cannot be combined with Evil or Neutral Factions, nor is there a Research <b>Tree</b> for Dwarven.</p>
	<p><b>Unlock Requirements</b>:</p>
	<p>These Requirements can be done in separate game plays.</p>
	<p><b><img src="/realm/Factions/picks/PassageToTheUnderWorld.png" align="middle"> Passage to the Underworld</b></p>
	...
	<br/>
	<p><b><img src="/realm/Factions/picks/UnderworldDiplomacy.png" align="middle"> Underworld Diplomacy</b></p>
	...
	<p><b><img src="/realm/Factions/picks/DwarvenTradeTreaty.png" align="middle"> Dwarven Trade Treaty</b></p>
	...
	<p><b>Cost</b>: 12,000 Dwarven Coins</p>
	...
	<p><b>Cost</b>: 30,000 Dwarven Coins</p>
	<p><b>Effect</b>: Unlocks more Dwarven Upgrades.</p>
	<br/>
	...
	<br/>
	<p><b><img src="/realm/Factions/picks/DwarvenForgeFactionUpgrade.png" align="middle"> Dwarven Forges</b></p>
	...
	<p><b>Formula</b>: (300 * (30 * x) ^ 0.6)%, where x is Mana Regeneration per tick; 30 * x is nominal Mana Regeneration per second.</p>
	...
	<p><b>Requirements</b>: R29 + 2,750th Excavation</p>
	<p><b>Effect</b>: Unlocks The Secrets of the Underworld upgrade.</p>
	<br/>
	<p><b><img src="/realm/Factions/picks/SecretsoftheUnderworldFactionUpgrade.png" align="middle"> Secrets of the Underworld</b></p>
	<p><b>Requirement</b>: Prestige Unique Building, Earth Core Artifact</p>
	<p><b>Cost</b>: 100 Sxg (1e185), 10 M (1e7) Faction Coins of each</p>
	...
	<br/>
	<p><b><img src="/realm/Factions/picks/HornoftheKingsFactionUpgrade.png" align="middle"> Legacy of The Dwarven Kings</b></p>
	...
	<p><b><img src="/realm/Factions/picks/DwarvenUniqueBuilding.png" alt="Unique building Dwarven" align="middle"></b></p>
	...
	<br/>
	<p><b><img src="/realm/Factions/picks/HighBastionQuest.png" align="middle"> High Bastion Quest</b></p>
	...
	<p><b>Requirement</b>: 5 free excav resets this Reincarnation</p>
	<p><b>Cost</b>: 100 Vg (1e65)</p>
	<p><b>Effect</b>: Grants access to Unique Building.</p>
	<br/>
	<p><b><img src="/realm/Factions/picks/HighBastion.png" align="middle"> Unique Building Upgrade</b></p>
