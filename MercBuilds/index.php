...
<?php include "../scripts/header.html"; ?>
    <h6><img src="/realm/Factions/picks/MercenaryTopPage.png" alt="Spellcraft" align="middle"></h6>
        ...
        <div class="category">
			<div class="shelementwhole">
				...
				<div class="autohide">
					...
					<p>
						<button onclick="myFunction($(this))">Copy Build</button>
						<input type="text" value="FR2,EL5,AN6,GB1,UD7,DM3,TT7,DD1,FC4,FC7,DN4,DW7,SP:Fairy Chanting,SP:God's Hand">
					</p>
					<p>
						<button onclick="myFunction($(this))">Copy Build</button>
						<input type="text" value="FR2,EL5,AN2,GB1,UD7,DM3,TT7,DD6,FC4,DN4,DN8,DW7,SP:Fairy Chanting,SP:God's Hand">
						<b>Excavation cost is too high</b>
					</p>
					<p><b>Template</b></p>
			...
			<div class="shelementwhole">
				...
				<div class="autohide">
					...
					<p><b>Bloodline</b>: Elf (<b>Ignore if you don't have Bloodline</b>)</p>
					<p>
						<button onclick="myFunction($(this))">Copy Build</button>
