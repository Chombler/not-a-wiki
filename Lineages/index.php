...
<?php include "../scripts/header.html"; ?>
	...
	<map name="Lineages-map">
		...
		<p><b>Base Effect</b>: Farms, Inns and Blacksmiths count 18% more for every level.</p>
		...
		<p><b>Base Effect</b>: Each lineage level counts as 2 additional Reincarnations.</p>
	...
	<p><b>Effect</b>: Reduces the cost of Lineage levels</p>
	<p><b>Note</b>: Only applies if the level of your current Lineage is lower than the highest Lineage level across all Lineages.</p>
	<p><b>Cost</b>: 10 Dtg (1e100) Diamond Coins, free in A2+</p>
	<p><b>Formula</b>: (x ^ 0.9), where x is the Lineage level cost.</p>
	<br/>
	<p><b><img src="/realm/Factions/picks/AncestralHourglassArtifact.png" align="middle"> Ancestral Hourglass</b> (Lore Artifact)</p>
	...
	<div id="LineageCalculator" class="calc">
		<table>
			...
			<tr>
				<td ><input id="LineageLevel" type="number" min="1" max="152" value="1"></td>
				<td ><input id="Heirloom" type="checkbox"></td>
				<td ><input id="Hourglass" type="checkbox"></td>
				<td class="HourglassRelated"><input id="HourglassR" type="number" min="100" max="279" value="100"></td>
