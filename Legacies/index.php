...
<?php include "../scripts/header.html"; ?>
	...
	<p><b>Formula</b>: (0.5 * (T ^ 1.5) * (x ^ 0.5)%, where x is the highest amount of Burning Abysses built in this Reincarnation, T is building tier.</p>
	<p></p>
	<p><b>Demonic Fury</b></p>
	...
	<p><b>Formula</b>: +(2 * x), where x is the highest amount of Stone Pillars built in this Reincarnation.</p>
	<p></p>
	...
	<p><b>Formula</b>: (x ^ 0.5)%, where x is total time spent as Faceless (all time).</p>
	...
	<p></p>
	<p><b>Indestructible Treasure</b></p>
	...
	<p></p>
	<p><b>Professional Assassins</b></p>
