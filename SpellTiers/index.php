...
<?php include "../scripts/header.html"; ?>
	...
	<p><b>Unlock Requirement</b>: For ordinary spells, Tier N requires N - 1 hours of that spell's activity time accumulated during the current Reincarnation, plus a spell-specific statistic requirement. A tier cannot appear before its Ascension is reached. There is no separate tier challenge requirement.</p>
	<p><b>After Tier 2</b>: Tier 3 becomes available in Ascension 2, Tier 4 in Ascension 3, and Tier 5 in Ascension 4. These tiers have no additional Reincarnation gate beyond reaching the appropriate Ascension. The next upgrade remains hidden until the spell is available and both its activity-time and spell-specific statistic requirements are fully met in the current Reincarnation. It then appears as an unlocked upgrade to purchase; the game does not show partial progress toward a hidden tier upgrade.</p>
	<p><b>Ascension 1 availability</b>: Tier 2 upgrades are introduced in stages by the Dragon quest. <b>Hatch!</b> at R42 enables Call to Arms and Spiritual Surge; <b>Drakeling</b> at R44 enables Blood Frenzy, Goblin's Greed, Night Time, Hellfire Blast, and Combo Strike; <b>Dragon</b> at R46 enables Holy Light, Fairy Chanting, Moon Blessing, God's Hand, and Diamond Pickaxe; and <b>Elder Dragon</b> at R48 enables Gem Grinder, Lightning Strike, Grand Balance, and Brainwave.</p>
