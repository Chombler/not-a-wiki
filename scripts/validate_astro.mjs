...
const contracts = {
  ...
  'Rubies/index.html': ['id="getting-rubies"', 'id="ruby-excavation-calculator"', 'function calculateRubyExcavation()', 'Math.expm1(growth)', 'calculator.addEventListener', 'currently owned Rubies', 'id="spending-rubies"', 'Ruby Assistant', '+1 Mana per second', 'id="ruby-reset-behavior"', 'Spent Rubies are refunded', 'id="ruby-upgrade-panel"', 'Ruby Power tiers', 'RubyTier1.png', '50 Rubies', 'id="ruby-appearance"', 'Rubies have one standard appearance'],
