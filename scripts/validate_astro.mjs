...
if (!trophyStyles.includes('.child-mode-current.is-current-root .guide-range-nav li')) {
  failures.push('Large sidebar collections no longer expand their children on the collection root page');
}
