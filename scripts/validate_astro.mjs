...
const contracts = {
  ...
  'BuildingAlignments/index.html': ['id="unrestricted-buildings"', 'id="building-cost-multiplier"'],
  ...
  'FactionCoins/index.html': ['id="faction-coin-types"', 'Corresponding faction', 'Elven Coins</td><td>Elf', 'Dwarven Coins</td><td>Dwarf', 'id="neutral-factions"', 'Titan</a></td><td><span class="faction-coin-list"', 'id="later-factions"', 'Prestige and Astral faction currency pairs', 'Dragon</a></td><td><span class="faction-coin-list"', 'id="finding-faction-coins"', 'id="spending-faction-coins"', 'fairy-coin-small.png', 'id="faction-coin-appearance"'],
};
